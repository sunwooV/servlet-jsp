...
public class LookVend extends HttpServlet {
	...
	protected void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(int i=0;i<list.size();i++) {
			...
			out.print("<tr><td>" + id + "</td><td>" + name + "</td><td>" + address + "</td><td>" + city + "</td><td>" + state + "</td><td>" + zip + "</td><td>" + country + "</td><td>" + "<a href='/practice/vendEdit.jsp?command=editVend&searchId=" + searchId + "&id=" + id + "&name=" + name + "&address=" + address + "&city=" + city + "&state=" + state + "&zip=" + zip + "&country=" + country + "'>수정</a></td><td>" + "<a href='/practice/vend?command=delVend&id=" + id + "&searchId=" + searchId + "'> 삭제 </a></td></tr>");
		}
