...
public class CustomerServlet extends HttpServlet {
	...
	protected void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
		...
		if(_command.equals("before")) { //이전 고객 조회
			System.out.println("before 들어왔음");
			...
			_command = "search";
		} else if(_command.equals("after")) { //이후 고객 조회
			System.out.println("after 들어왔음");
		...
		if(_command.equals("search")) { //조회
			...
			String copyId = (String)request.getParameter("copyId"); //조회 후 수정인지 추가인지 구별하기 위함
			...
			System.out.println("delete 들어왔음");
