...
<body>
	...
	<h1>게시판</h1>
		...
		<div>
		<table border="1" style="border-color:#D8D8D8; width:100%" >
		 <tr bgcolor="white">
		 	<td colspan="4"><a href="write.do">게시글쓰기</a></td>
		 </tr>
	 	<tr>
		 	<th bgcolor="skyblue" align="center">번호</th>
			<th bgcolor="skyblue" align="center">제목</th>
			<th bgcolor="skyblue" align="center">작성자</th>
			<th bgcolor="skyblue" align="center">조회수</th>
		</tr>
